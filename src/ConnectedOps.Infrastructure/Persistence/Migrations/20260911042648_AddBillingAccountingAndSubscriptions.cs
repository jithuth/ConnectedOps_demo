...
{
    /// <inheritdoc />
    public partial class AddBillingAccountingAndSubscriptions : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GeneralLedgerAccounts_Tenants_TenantId",
                        column: x => x.TenantId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BillingContactName = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasAuditExport = table.Column<bool>(type: "bit", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LedgerEntries_GeneralLedgerAccounts_AccountId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomMaxVehicles = table.Column<int>(type: "int", nullable: true),
                    CustomMaxAssets = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LedgerEntries_TenantId_AccountId",
                table: "LedgerEntries",
                columns: new[] { "TenantId", "AccountId" });

            migrationBuilder.CreateIndex(
                name: "IX_LedgerEntries_TenantId_EntryDateUtc",
                table: "LedgerEntries",
                columns: new[] { "TenantId", "EntryDateUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_LedgerEntries_TenantId_EntryNumber",
                table: "LedgerEntries",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentTransactions_TenantId_TransactionReference",
                table: "PaymentTransactions",
